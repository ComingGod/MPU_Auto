...
class TestSDBoot:
    ...
    def test_sd_boot_image_cm4_ddr(self):
        messagebox()
        #download image
        self.image.download_image('test_sd_boot_image_cm4_ddr', 'sd', SDPimage = self.config['Image']['serial_download'], 
    ...
    def test_sd_boot_image_cm4_tcm(self):
        messagebox()
        #download image
        self.image.download_image('test_sd_boot_image_cm4_tcm', 'sd', SDPimage = self.config['Image']['serial_download'], 
    ...
    def test_sd_boot_image1_invalid_SECO_container_image2_uboot(self):
        messagebox()
        #download image
        self.image.download_image('test_sd_boot_image1_invalid_SECO_container_image2_uboot', 'sd', SDPimage = self.config['Image']['serial_download'], 
...
if __name__ == '__main__':
    ...
    subprocess.call([pytest, '-v' ,'-s', 'test_sd_boot.py::TestSDBoot::test_sd_boot_image_cm4_ddr' ])
    # pytest.main(['-v', '-s'])
